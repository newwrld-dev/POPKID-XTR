// 1. Fix the Import: Use Namespace Import for Baileys
import baileys, {
    getContentType,
    jidDecode,
    ...
    generateWAMessageFromContent // Added this as it was missing in your original import but used in copyNForward
} from "@whiskeysockets/baileys";

// Extract the missing tools from the default export
const { makeInMemoryStore, downloadMediaMessage } = baileys;
